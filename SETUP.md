...
| Customer | rahul@example.com | password  |
...
app/
  Http/
    Controllers/
      ...
      CustomerController.php      – customer loan operations
      Admin/LoanController.php    – admin review actions
    Middleware/
      CheckRole.php               – role-based route guard
  Models/
    User.php
    Loan.php                      – EMI calc + schedule generation
    Repayment.php

database/
  migrations/                     – users, loans, repayments tables
  seeders/DatabaseSeeder.php      – seeds admin + demo customer
...
resources/views/
  ...
  customer/loans/{index,create,show}.blade.php
  admin/dashboard.blade.php
  admin/loans/{index,show}.blade.php

routes/web.php                    – all web routes
loan_management.sql               – database dump
```
